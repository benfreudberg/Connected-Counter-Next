...
public:
	...
	public:
		...
		uint16_t hourlyCount;                             	// Counts in the current hour
		uint16_t dailyCount;                              	// Counts in the current day
		...
		uint8_t sensorState;                             	// Stores the current sensor state (WAITING:0, SENSING:1)
	};
